...
class RootNavigationController: UINavigationController{
    ...
    func defaultSetting(){
        ...
        self.navigationBar.titleTextAttributes = [NSAttributedStringKey.foregroundColor : UIColor.colorWithRGB(r:51/255, g: 51/255, b: 51/255, alpha: 1),NSAttributedStringKey.font:UIFont.systemFont(ofSize:17)]
